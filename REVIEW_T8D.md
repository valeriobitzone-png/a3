...
Screenshot (not in git): `/Users/ambrogio/Downloads/a3-t8d-single-entry.png`
...
**How:** `./gradlew :launcher:clean :launcher:assembleDebug` (niente `--rerun-tasks` aggregato). APK `launcher/build/outputs/apk/debug/launcher-debug.apk` mtime `2026-08-30T17:28:44+02:00` > `f18c393` (`2026-08-30T15:19:07+02:00`). Cold reinstall Tab A9 serial `R9ZY80P8GRH`.

```
adb -s R9ZY80P8GRH shell dumpsys package a3.launcher | grep -A3 "android.intent.action.MAIN"
