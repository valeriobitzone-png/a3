...
/**
 * Belief atom. Schema fields: k, v, confidence, source, observed_at, expires_at.
 * [id] and [supersededBy] are internal history metadata and are omitted from schema JSON.
 */
data class Fact(
    val k: String,
    val v: Any?,
