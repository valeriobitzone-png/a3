...
@Composable
internal fun ShowcaseAmbient(expanded: Boolean, reduced: Boolean, paper: Color, modifier: Modifier = Modifier) {
    val tokens = ShowcaseTokens.snapshot
    ...
    Box(
        ...
        BasicText(
            ...
            style = MacTheme.type.copy(fontSize = 12.sp, color = paper)
        )
    }
}
