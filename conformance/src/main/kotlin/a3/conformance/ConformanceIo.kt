...
object ConformanceIo {
    ...
    val expectedSha256: Map<String, String> = mapOf(
    ...
    val coreLockPaths: Map<String, String> = mapOf(
    ...
    fun eventIdExpected(): String =
        File(ConformancePaths.vectors(), "event_id_expected.txt").readText().trim()
