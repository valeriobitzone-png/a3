...
|------|-----------|----------|--------|
| NS-001 | Valid `x-mono-gate` payload crosses unchanged | `ExtensionsTest.NS_001_valid_mono_extension_crosses_opaque_protocol` | PASS |
...
The implementation is new headless Kotlin code in this repository. Extension payloads are not interpreted. No MONO import or name is used. No tests were deleted or weakened, and no renderer is used by the B4 tests.
