...
| AC-030 | `x-consumer-gate` extension crosses opaquely | `B5ConformanceTest.AC_030_x_consumer_gate_extension_passes_opaque` | PASS |
...
Observed result: empty. Only the existing conformance module and its review were changed. No renderer test, B5b web suite, private consumer, or graphics repository was touched.
