...
def sp_007() -> None:
    proc = subprocess.run(
        ["git", "diff", "--stat", "--", ".", ":!spec", ":!REVIEW_SPEC_A3EP.md", ":!REVIEW_SPEC_A3UI.md", ":!REVIEW_CONFORMANCE_A3EP.md", ":!REVIEW_PROTOCOL_V2.md", ":!REVIEW_A3UI_CONFORMANCE.md", ":!conformance", ":!settings.gradle.kts", ":!core/envelope"],
        cwd=ROOT,
        check=False,
        capture_output=True,
        text=True,
    ...
    allowed = ("spec/", "REVIEW_SPEC_A3EP.md", "REVIEW_SPEC_A3UI.md", "REVIEW_CONFORMANCE_A3EP.md", "REVIEW_PROTOCOL_V2.md", "REVIEW_A3UI_CONFORMANCE.md", "conformance/", "settings.gradle.kts", "core/envelope/")
