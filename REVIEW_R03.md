...
- `/Users/ambrogio/Downloads/a3-r03-paint.png` — `08:45` / `09:12` / `10:03`, `Ada`, `12.40`, confirm atom `true`
- `/Users/ambrogio/Downloads/a3-r03-trust.png` — tap on `true` → overlay copy `approve`
